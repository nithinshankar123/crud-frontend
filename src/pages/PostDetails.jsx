...
const PostDetails = () => {
  ...
  return (
    <div>
        ...
        <div className="flex justify-between items-center" style={{color:"orange"}}>
       ...
       <p>{new Date(post.updatedAt).toString().slice(16,24)}</p>
        ...
        <img src={IF+post.photo} className="w-full  mx-auto mt-8" alt=""/>
         ...
         <div className="w-full flex flex-col mt-4 md:flex-row">
          ...
          <button onClick={postComment} className=" text-sm text-white px-2 py-2 md:w-[20%] mt-4 md:mt-0"  style={{
    background: "#FF6500",
