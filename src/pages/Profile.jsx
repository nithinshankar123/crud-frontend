...
useEffect(()=>{
    ...
    <div>
      ...
      <div className="min-h-[80vh] px-8 md:px-[200px] mt-8 flex md:flex-row flex-col-reverse md:items-start items-start">
        <div className="flex flex-col md:w-[70%] w-full mt-8 md:mt-0">
          <h1 className="text-xl font-bold mb-4" style={{color:'orange'}}>Your posts:</h1>
          {posts?.map((p)=>(
        ...
        <h1 className="text-xl font-bold mb-4" style={{color:'orange'}}>Profile</h1>
          ...
          <div className="flex items-center space-x-4 mt-8">
            <button onClick={handleUserUpdate} className="text-white font-semibold  px-4 py-2 hover:text-black hover:bg-gray-400"   style={{
    background: "#FF6500",
  ...
  onMouseOut={(event) => {
    ...
    event.target.style.borderRadius = "20px";
            ...
            <button onClick={handleUserDelete} className="text-white font-semibold  px-4 py-2 hover:text-black hover:bg-gray-400"  style={{
    background: "#FF6500",
    transition: "all 0.2s ease-in-out",
  }}
  onMouseOver={(event) => {
