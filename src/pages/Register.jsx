...
const Register = () => {
  ...
  <h2 className="text-lg md:text-xl font-extrabold" style={{color:"#FF6500"}}><Link to="/">Blogosphere</Link></h2>
  <h3 style={{color:"#FF6500"}}><Link to="/login">Login</Link></h3>
  </div>
    <div className="w-full flex justify-center items-center h-[80vh] ">
       <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]">
         <h1 className="text-xl font-bold text-left" style={{color:"#FF6500"}}>create an account</h1>
         ...
         <button onClick={handleRegister} className="w-full px-4 py-4 text-lg font-bold text-white  rounded-lg hover:bg-gray-500 hover:text-black " style={{
    background: "#FF6500",
  ...
  onMouseOut={(event) => {
    ...
    event.target.style.borderRadius = "20px";
         ...
         {error && <h3 className="text-red-500 text-sm " >Something went wrong</h3>}
          ...
          <p style={{color:"#FF6500"}}>Already have an account?</p>
          <p className="text-gray-500 hover:text-black"><Link to="/login" style={{color:"#FF6500"}}>Log in</Link></p>
         </div>
